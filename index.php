                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black;  font-weight:bold;">VROOM!</h1>
                            <p class="intro-text h5" style="color:white">
